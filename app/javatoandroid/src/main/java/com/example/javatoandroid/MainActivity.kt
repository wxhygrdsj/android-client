...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener {
            ...
            sendRequestWithHttpURLConnection(data,"http://8.135.69.192:8080/stuprogram_war/loginServlet")
        }
        ...
        thread {
            ...
            try {
                ...
                if(responseCode==200){
                    ...
                    if(result=="100"){
                        var url2 = URL("http://8.135.69.192:8080/stuprogram_war/returnStudentsServlet")
